...
from factguard_azure.azure_openai import analyse_information
...
- **Note** : Analyse effectuée sans contexte historique
            ...
            result = analyse_information(fallback_prompt)
...
---"""
        ...
        # 4. Prompt optimisé avec instructions spécifiques[7]
        enhanced_prompt = f"""
...
IMPORTANT : Tu DOIS utiliser et citer le contexte historique dans ta réponse.
        ...
        result = analyse_information(enhanced_prompt)
        ...
        return {
            ...
            'search_query': user_query,
            'enhanced_prompt': enhanced_prompt,  # Pour debug
            'mode': 'rag_enhanced'
        }
